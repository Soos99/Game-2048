...
public class LeaderboardsPanel extends GuiPanel{
    ...
    public LeaderboardsPanel(){
        ...
        GuiButton tileButton = new GuiButton(Game.WIDTH - buttonWidth - buttonSpacing , buttonY, buttonWidth, buttonHeight);
        ...
        GuiButton scoreButton = new GuiButton( buttonSpacing, buttonY, buttonWidth, buttonHeight);
